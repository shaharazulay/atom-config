...
describe("Axis", function () {
  it("renders without crashing", function () {
    (0, _enzyme.mount)(_react.default.createElement(_Axis.default, axisProps));
  });
  var shallowAxis = (0, _enzyme.shallow)(_react.default.createElement(_Axis.default, _extends({}, axisProps, {
  ...
  it("renders with annotation brush area properly", function () {
    ...
    var shallowAxisBrushLeft = (0, _enzyme.shallow)(_react.default.createElement(_Axis.default, _extends({}, axisProps, {
    ...
    var shallowAxisBrushBottom = (0, _enzyme.shallow)(_react.default.createElement(_Axis.default, _extends({}, axisProps, {
      annotationFunction: testFuncStub,
      orient: "bottom"
    })));
