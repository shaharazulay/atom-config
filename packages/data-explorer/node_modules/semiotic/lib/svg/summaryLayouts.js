...
function boxplotRenderFn(_ref2) {
  var data = _ref2.data,
      ...
      positionFn = _ref2$positionFn === undefined ? function (position) {
    return position;
  } : _ref2$positionFn,
    ...
    if (projection === "radial") {
      ...
      renderedSummaryMarks.push(_react2.default.createElement(
        ...
        _extends({}, eventListeners, {
          ...
          tabIndex: -1,
          "data-o": key,
          "aria-label": key + " boxplot showing " + summaryXYCoords.filter(function (d) {
            return d.key === key;
          }).map(function (d) {
...
var drawSummaries = exports.drawSummaries = function drawSummaries(_ref6) {
  var data = _ref6.data,
      type = _ref6.type,
...
var renderLaidOutSummaries = exports.renderLaidOutSummaries = function renderLaidOutSummaries(_ref7) {
  var data = _ref7.data;
  return data.marks;
};