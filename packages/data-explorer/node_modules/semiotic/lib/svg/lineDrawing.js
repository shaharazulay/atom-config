...
exports.dividedLine = exports.bumpChart = exports.cumulativeLine = exports.lineChart = exports.stackedArea = exports.differenceLine = exports.projectLineData = exports.projectAreaData = undefined;
...
var projectLineData = exports.projectLineData = function projectLineData(_ref2) {
  ...
  lineDataAccessor.forEach(function (actualLineAccessor) {
    xAccessor.forEach(function (actualXAccessor) {
      yAccessor.forEach(function (actualYAccessor) {
        data.forEach(function (d) {
...
var cumulativeLine = exports.cumulativeLine = function cumulativeLine(_ref6) {
  var data = _ref6.data,
      yPropTop = _ref6.yPropTop,
      yPropMiddle = _ref6.yPropMiddle,
      yPropBottom = _ref6.yPropBottom,
      _ref6$type = _ref6.type,
      type = _ref6$type === undefined ? "cumulative" : _ref6$type;
...
var bumpChart = exports.bumpChart = function bumpChart(_ref7) {
  var _ref7$type = _ref7.type,
      type = _ref7$type === undefined ? "bumpline" : _ref7$type,
      data = _ref7.data,
      xProp = _ref7.xProp,
      yProp = _ref7.yProp,
...
function relativeY(_ref10) {
  var point = _ref10.point,
      projectedYMiddle = _ref10.projectedYMiddle,
      projectedY = _ref10.projectedY,
      yAccessor = _ref10.yAccessor,
      yScale = _ref10.yScale;

  var baseData = point && (point[projectedYMiddle] !== undefined ? point[projectedYMiddle] : point[projectedY] !== undefined ? point[projectedY] : (0, _multiAccessorUtils.findFirstAccessorValue)(yAccessor, point));
...
function findPointByID(_ref12) {
  ...
  if (pointID) {
    ...
    var thisPoint = thisLine.data.find(function (p) {
      return xScale(p[projectedX]) === xScale((0, _multiAccessorUtils.findFirstAccessorValue)(xAccessor, point));
    });
    ...
    var newPoint = _extends({}, point, thisPoint, thisPoint.data, {
      parentLine: thisLine
    });
