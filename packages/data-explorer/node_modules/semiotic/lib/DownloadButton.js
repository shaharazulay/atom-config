...
var DownloadButton = function (_React$Component) {
  ...
  function DownloadButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DownloadButton.__proto__ || Object.getPrototypeOf(DownloadButton)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function () {
  ...
  _createClass(DownloadButton, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "download-div", style: style },
        _react2.default.createElement(
          "button",
          { alt: "download", onClick: this.onClick },
          _react2.default.createElement(
            "a",
            null,
            label
