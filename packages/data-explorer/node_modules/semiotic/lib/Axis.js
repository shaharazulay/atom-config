...
var Axis = function (_React$Component) {
  ...
  function Axis(props) {
    ...
    _this.calculateLabelPosition = function () {
      _this.setState({ calculatedLabelPosition: _this.boundingBoxMax() });
    };

    _this.boundingBoxMax = function () {
      if (!_this.axisRef) return 30;
      var _this$props$orient = _this.props.orient,
          orient = _this$props$orient === undefined ? "left" : _this$props$orient;


      var positionType = orient === "left" || orient === "right" ? "width" : "height";

      var axisLabelMax = Math.max.apply(Math, _toConsumableArray([].concat(_toConsumableArray(_this.axisRef.querySelectorAll(".axis-label"))).map(function (l) {
  ...
  _createClass(Axis, [{
    ...
    value: function componentDidMount() {
      var _props$label2 = this.props.label,
    ...
    value: function render() {
      ...
      var axisAriaLabel = orient + " axis " + (axisParts && axisParts.length > 0 && "from " + tickFormat(axisParts[0].value, 0) + " to " + tickFormat(axisParts[axisParts.length - 1].value, axisParts.length - 1) || "without ticks");
